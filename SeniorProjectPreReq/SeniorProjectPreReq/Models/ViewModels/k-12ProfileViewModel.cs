...
{
    public class k_12ProfileViewModel

    {
            ...
            [Display(Name = "Kindergarden Readiness")]
            [DisplayFormat(DataFormatString = "{0:P2}", ApplyFormatInEditMode = true)]
            public float KReadiness { set; get; }

            [Display(Name = "Algebra I EOC Passing Rate")]
            [DisplayFormat(DataFormatString = "{0:P2}", ApplyFormatInEditMode = true)]
            public float algPassRate { set; get; }
