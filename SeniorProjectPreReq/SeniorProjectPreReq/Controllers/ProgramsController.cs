...
namespace SeniorProjectPreReq.Controllers
{
    public class ProgramsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProgramID,Program_Name,Program_Description,Program_Level")] Programs programs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProgramID,Program_Name,Program_Description,Program_Level")] Programs programs)
        {
            if (ModelState.IsValid)
            {
